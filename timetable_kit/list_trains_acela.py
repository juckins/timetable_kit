#! /usr/bin/env python3
# list_trains_acela.py
# Part of timetable_kit
# Copyright 2022, 2023 Nathanael Nerode.  Licensed under GNU Affero GPL v.3 or later.
"""Two modes of invocation ./list_trains_acela STATION: Find all the Acela trains
which stop at STATION. Acela train numbers are 4 digits long and begin with a "2".

./list_trains_acela STATION_A STATION_B: Find all the Acela trains from station A to
...
def make_argparser():
    """Argument parser for list_trains_acela"""
...
if __name__ == "__main__":
    ...
    # Print out only the 4-digit train numbers that begin with a "2" (the Acela runs)
    sorted_tsns = [
